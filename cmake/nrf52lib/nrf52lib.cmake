...
# Include libraries
include(${NRF_COMPONENTS_CMAKE_DIR}/toolchain/toolchain.cmake)
include(${NRF_COMPONENTS_CMAKE_DIR}/softdevice/softdevice.cmake)
include(${NRF_COMPONENTS_CMAKE_DIR}/device/device.cmake)
include(${NRF_COMPONENTS_CMAKE_DIR}/ble/ble.cmake)
...
set(COMMON_DEFINITIONS "${OPTIONAL_DEBUG_SYMBOLS} -D${DEVICE_U} -D${CPU_FAMILY_U} -D${BOARD}")
...
set(CMAKE_EXE_LINKER_FLAGS "-Xlinker -L${LINKER_TEMPLATE_LOC} -T${LINKER_SCRIPT} -lc -Wl,-Map=${TARGET}.map -Wl,--gc-sections")
